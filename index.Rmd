...
```{r}
#Gráfico de Barras para casos activos
...
```{r}
#Gráfico de Barras para casos fallecidos
barplot(height=ca_covid19$fallecidos)

#Gráfico de Barras Ordenado para casos fallecidos
cantidaddefallecidos.ordenados<- order(ca_covid19$fallecidos, decreasing=FALSE)
