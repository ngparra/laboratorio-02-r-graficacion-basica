...
author: "Nicole G. Parra Barrientos"
date: "20-04-2020"
output:
  html_document:
    theme: readable    
...
```{r}
confirmados.ordenados<- order(ca_covid19$confirmados, decreasing=TRUE)

ca_covid19.confirmado <- ca_covid19[confirmados.ordenados,]

barplot(height=ca_covid19.confirmado$confirmados)
```
...
```{r}
barplot(
  height=ca_covid19.confirmado$confirmados, 
  names.arg=ca_covid19.confirmado$pais, 
  xlab="Países", 
  ylab="Cantidad de Personas", 
  main="Cantidad de casos confirmados de América Central y República Dominicana"
)
```
...
```{r}
#Grafico de Barras Ordenado para casos activos

casosactivos.ordenados<-order(ca_covid19$activos, decreasing=TRUE)

ca_covid19.casosactivos<-ca_covid19[casosactivos.ordenados,]

barplot(height=ca_covid19.casosactivos$activos)

#Gráfico de Barras Ordenado con titulo y nombre de ejes para los casos activos

barplot(
  height=ca_covid19.casosactivos$activos, 
  names.arg=ca_covid19.casosactivos$pais, 
  xlab="Países", 
  ylab="Casos Activos", 
  main="Cantidad de Casos Activos de América Central y República Dominicana"
)
```

```{r}

#Gráfico de Barras Ordenado para casos fallecidos

cantidaddefallecidos.ordenados<- order(ca_covid19$fallecidos, decreasing=TRUE)

ca_covid19.cantidaddefallecidos<- ca_covid19[cantidaddefallecidos.ordenados,]

barplot(height=ca_covid19.cantidaddefallecidos$fallecidos)

#Gráfico de Barras Ordenado con titulo y nombre de ejes para los casos fallecidos
barplot(
  height=ca_covid19.cantidaddefallecidos$fallecidos, 
  names.arg=ca_covid19.cantidaddefallecidos$pais, 
  xlab="Países", 
  ylab="Cantidad de Fallecidos", 
  main="Cantidad de Fallecidos de América Central y República Dominicana"
)
```
